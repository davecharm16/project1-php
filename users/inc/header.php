<?php
    session_start();
    if (empty($_SESSION['user_username']) || $_SESSION['user_type'] != 'USER') {
    ...
    // die("SELECT * FROM members1 WHERE user_id = '$username'");
    ...
    $picture = $row['picture'];
    $eda_education = $row['education'];
    $eda_skills = $row['skills'];
?>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <li class="user-header">
                                ...
                                <small><?php echo "Username: $username"; ?></small>
                                <!-- <br>Web Developer -->
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                <a href="profile.php" class="btn btn-default btn-flat btn-sm">Change Password</a>
                                </div>
