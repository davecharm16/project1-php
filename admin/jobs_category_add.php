<?php
    ...
    $qry = mysqli_query($con,"SELECT * FROM jobs_category WHERE category_name = '$category_name'");
    if (mysqli_num_rows($qry) < 1) {
        $qry2 = mysqli_query($con,"INSERT INTO jobs_category (category_name) VALUES ('$category_name')");
