<?php
    ...
    $qry = mysqli_query($con,"UPDATE user_info SET lastname = '$lastname', firstname = '$firstname', middlename = '$middlename', contact_no = '$contact_no', email_address = '$email_address' WHERE user_id = '$id'");
    $msg = md5(2);
