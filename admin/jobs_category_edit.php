<?php
    ...
    $jobcat_id = $_GET['a'];
    $qry = mysqli_query($con,"SELECT * FROM jobs_category WHERE id = '$jobcat_id'");
...
?>
    ...
    <section class="content-header">
        <h1>Edit Job</h1>
        <ol class="breadcrumb">
            <li><a href="jobs_category.php"><i class="fa fa-briefcase"></i> Jobs Category Management</a></li>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-8">
                        <form method="POST" action="jobs_category_edit_details.php?id=<?php echo $jobcat_id ?>">
                            <div class="row">
                                <div class="col-sm-4">
