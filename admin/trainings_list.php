                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    <?php
                                        $qry2 = mysqli_query($con,"SELECT * FROM member_qualifications WHERE b1 = 'A' AND b2 = 'A' AND b3 = 'A' AND b4 = 'A' AND b5 = 'A' AND b6 = 'A' AND b7 = 'A' AND d1 = 'A' AND d2 = 'A' AND d3 = 'A' AND d4 = 'A' AND d5 = 'A' AND d6 = 'A'");
                                        while ($row2 = mysqli_fetch_array($qry2)) {
                                            ...
                                            $qry4 = mysqli_query($con,"SELECT status FROM enrolee WHERE member_id = '$member_id' AND training_id = '$training_id'");
