<?php
    ...
    if (mysqli_num_rows($qry) < 1) {
        if (move_uploaded_file($file_tmp,$file_target)) {
            $qry2 = mysqli_query($con,"INSERT INTO trainings (name,description,fimage,training_date,posted_on,posted_by,updated_on,updated_by,status) VALUES ('$training_name','$training_description','$file_target','$trainDate','$posted_on','$posted_by','','','open')");
            $msg = md5(1);
