...
?>
    ...
    <section class="content-header">
      <h1>Summary of Jobs, Trainings, and Livelihood Programs</h1>
      <ol class="breadcrumb">
        <li><i class="fa fa-file-text-o"></i> Reports</li>
        <li class="active">Admin Reports</li>
      </ol>
    </section>
                                ...
                                <form method="POST">
                                    <div class="form-group">
                                        ...
                                        <select name="category" id="category" class="form-control" required>
                                            ...
                                            <option value="jobs" <?php if ($category == 'jobs') echo "selected"; ?>>Jobs</option>
                                            <option value="trainings" <?php if ($category == 'trainings') echo "selected"; ?>>Trainings</option>
                                            <option value="projects" <?php if ($category == 'projects') echo "selected"; ?>>Livelihood Projects</option>
                                        </select>
                                    </div>
                                    <!-- Date range -->
                                    <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <?php
                                        ...
                                        while ($row = mysqli_fetch_array($qry)) {
                                            ...
                                            $column4 = 0;
                                            if ($category == 'jobs') {
                                                $sql2 = "SELECT * FROM applicants WHERE job_id = '$category_id'";
                                                ...
                                                $sql2 = "SELECT * FROM enrolee WHERE training_id = '$category_id'";
                                                $qry2 = mysqli_query($con,$sql2);
                                                $column1 = mysqli_num_rows($qry2);
                                                ...
                                                $sql2 = "SELECT * FROM beneficiary WHERE project_id = '$category_id'";
                                                $qry2 = mysqli_query($con,$sql2);
                                                $column1 = mysqli_num_rows($qry2);
