<?php
    ...
    $qry = mysqli_query($con,"UPDATE jobs_category SET category_name = '$category_name' WHERE id = '$id'");
    $msg = md5(2);
    echo "<script>window.location.replace('jobs_category_edit.php?a=$id&s=$msg')</script>";
?>