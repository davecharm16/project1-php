...
?>
    ...
    <section class="content-header">
      <h1>Summary of Jobs by Category</h1>
      <ol class="breadcrumb">
        <li><i class="fa fa-file-text-o"></i> Reports</li>
        <li class="active">Summary of Jobs by Category</li>
      </ol>
    </section>
                                ...
                                <form method="POST">
                                    ...
                                    <div class="input-group">
                                        <select name="category" id="category" class="form-control" required>
                                            ...
                                            <?php
                                                $sql = "SELECT * FROM jobs_category ORDER BY category_name ASC";
                            ...
                            <div class="col-sm-8">
                                ...
                                ?>
                                    <table class="table table-hover table-bordered" id="example1">
                                        ...
                                        <tbody>
                                <?php 
                                        $sql ="SELECT * FROM jobs WHERE category LIKE '%$category%' ORDER BY category";
                                        $qry = mysqli_query($con,$sql);
                                        while ($row = mysqli_fetch_array($qry)) {
                                            $job_name = $row['name'];
