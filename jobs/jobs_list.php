<?php
    ...
    $job_id = $_GET['a'];
    $qry = mysqli_query($con,"SELECT name,description FROM jobs WHERE id = '$job_id'");
...
?>
    ...
    <section class="content-header">
      ...
      <small><?php echo "$job_description"; ?></small>
      <ol class="breadcrumb">
        <li><a href="jobs.php"><i class="fa fa-briefcase"></i> Jobs</a></li>
        <li class="active"><?php echo "$job_name"; ?></li>
      </ol>
    </section>
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    <?php
                                        $qry2 = mysqli_query($con,"SELECT * FROM member_qualifications WHERE a1 = 'A' AND a2 = 'A' AND a3 = 'A' AND a4 = 'A' AND a5 = 'A' AND a6 = 'A' AND a7 = 'A' AND a8 = 'A' AND d1 = 'A' AND d2 = 'A' AND d3 = 'A' AND d4 = 'A' AND d5 = 'A' AND d6 = 'A'");
                                        while ($row2 = mysqli_fetch_array($qry2)) {
                                            ...
                                            $qry4 = mysqli_query($con,"SELECT status FROM applicants WHERE member_id = '$member_id' AND job_id = '$job_id'");
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center vertical-middle">
                                            <select class="form-control" name="status" data-id="<?php echo $member_id ?>">
                                                ...
                                                <option value="A" <?php if ($status == 'A') { echo "selected"; } ?>>For Interview</option>
                                                <option value="B" <?php if ($status == 'B') { echo "selected"; } ?>>Hired</option>
                                                <option value="C" <?php if ($status == 'C') { echo "selected"; } ?>>Not Hired</option>
                                            </select>
                                        </td>
                                    </tr>
