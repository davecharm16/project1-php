<?php
    ...
    $qry2 = mysqli_query($con,"SELECT * FROM company");
    $qry3 = mysqli_query($con,"SELECT DISTINCT(member_id) FROM applicants");
    $count1 = mysqli_num_rows($qry1);
    $count2 = mysqli_num_rows($qry2);
    $count3 = mysqli_num_rows($qry3);
    $qry4 = mysqli_query($con,"SELECT DISTINCT(applicants.member_id) FROM applicants LEFT JOIN eda ON applicants.member_id = eda.eda_id WHERE eda.gender = 'MALE'");
    $countMale = mysqli_num_rows($qry4);
    $qry5 = mysqli_query($con,"SELECT DISTINCT(applicants.member_id) FROM applicants LEFT JOIN eda ON applicants.member_id = eda.eda_id WHERE eda.gender = 'FEMALE'");
    $countFemale = mysqli_num_rows($qry5);
?>
