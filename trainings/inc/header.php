<?php
    session_start();
    if (empty($_SESSION['training_username']) || $_SESSION['training_type'] != 'TESDA') {
        header("Location: ../index.php");
    }
    include("../dbcon.php");
    $user_id = $_SESSION['training_id'];
    $username = $_SESSION['training_username'];
    $user_type = $_SESSION['training_type'];
