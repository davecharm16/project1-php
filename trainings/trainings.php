                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    <?php
                                        $qry = mysqli_query($con,"SELECT * FROM trainings WHERE posted_by = '$username'");
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <textarea class="textarea" name="training_description" placeholder="Training Description" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                        <div class="form-group">
                            <label>Training Category (You can select multiple categories.)</label>
                            <select class="form-control select2" name="training_category[]" multiple="multiple" style="width: 100%;" data-placeholder="Select Category" required>
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="training_skills[]" multiple="multiple" style="width: 100%;" data-placeholder="Select Skills" required>
