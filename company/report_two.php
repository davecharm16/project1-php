<?php
    ...
    if (isset($_POST['btnGo'])) {
        ...
        $job_id = sanitizedString($con,$_POST['job_id']);
    }
?>
                            ...
                            <div class="col-sm-4">
                                <form method="POST">
                                    ...
                                    <select name="application_date" id="application_date" class="form-control" required>
                                        ...
                                        <?php
                                            $sql2 = "SELECT DISTINCT(application_date) FROM applicants ORDER BY application_date";
                                    ...
                                    <div class="input-group">
                                        <select name="job_id" id="job_id" class="form-control" required>
                                            ...
                                            <?php
                                                $sql = "SELECT * FROM jobs WHERE posted_by = '$username' AND company_id = '$company_id' ORDER BY name";
                                                ...
                                                while ($row = mysqli_fetch_array($qry)) {
                                                    ...
                                                    $job_name = $row['name'];
                                                    ?>
                                                        <option value="<?php echo $job_id1; ?>" <?php if ($job_id1 == $job_id) echo "selected"; ?>><?php echo "$job_name"; ?></option>
                                                    <?php
                                                }
                                            ?>
                                        </select>
                            ...
                            <div class="col-sm-8">
                                ...
                                ?>
                                    <table class="table table-hover table-bordered" id="example1">
                                        ...
                                        <tbody>
                                <?php 
                                        $sql3 ="SELECT * FROM applicants WHERE job_id = '$job_id' AND application_date = '$application_date' ORDER BY member_id";
                                        ...
                                        while ($row = mysqli_fetch_array($qry3)) {
                                            ...
                                            if ($status == 'A') $status1 = "For Interview";
                                            else if ($status == 'B') $status1 = "Hired";
                                            else if ($status == 'C') $status1 = "Not Hired";
