<?php
    ...
    if (isset($_POST['btnGo'])) {
        ...
        $project_id = sanitizedString($con,$_POST['project_id']);
    }
?>
                            ...
                            <div class="col-sm-4">
                                <form method="POST">
                                    ...
                                    <select name="application_date" id="application_date" class="form-control" required>
                                        ...
                                        <?php
                                            $sql2 = "SELECT DISTINCT(application_date) FROM beneficiary ORDER BY application_date";
                                    ...
                                    <label for="project_id">Select Livelihood Program</label>
                                        ...
                                        <select name="project_id" id="project_id" class="form-control" required>
                                            ...
                                            <?php
                                                ...
                                                while ($row = mysqli_fetch_array($qry)) {
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $project_id1; ?>" <?php if ($project_id1 == $project_id) echo "selected"; ?>><?php echo "$project_name"; ?></option>
                                                    <?php
                                                }
                                            ?>
                                        </select>
                            ...
                            <div class="col-sm-8">
                                ...
                                ?>
                                    <table class="table table-hover table-bordered" id="example1">
                                        ...
                                        <tbody>
                                <?php 
                                        $sql3 ="SELECT * FROM beneficiary WHERE project_id = '$project_id' AND application_date = '$application_date' ORDER BY member_id";
                                        ...
                                        while ($row = mysqli_fetch_array($qry3)) {
                                            ...
                                            if ($status == 'A') $status1 = "Granted";
                                            else if ($status == 'B') $status1 = "Not Granted";
